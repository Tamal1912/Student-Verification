      ...
      <div className="bg-black p-10 rounded-lg shadow-lg w-96 text-center">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-md cursor-pointer transition-transform transform hover:scale-105">
            <h2 className="text-white text-xl font-semibold mb-2">SignUp as Student</h2>
          </div>
            </Link>
          <div className="bg-gray-800 p-6 rounded-lg shadow-md cursor-pointer transition-transform transform hover:scale-105">
            <h2 className="text-white text-xl font-semibold mb-2">SignUp as Admin</h2>
          </div>
        </div>
      </div>
    </div>
...
export default RolesSelectionSignUp